...
{
    public IEnumerable<INode> GetSelectiveNodesAsEnumerable(Func<INode, bool> predicate) => GetSelectiveLooseNodesAsEnumerable(predicate);
    ...
    public IEnumerable<INode> GetSelectiveNodesAsEnumerable(Func<int, bool> predicate) => GetSelectiveLooseNodesAsEnumerable(predicate);

    public IEnumerable<INode> GetSelectiveNodesAsEnumerable(Func<int, bool> predicate, Action<INode> onChildRetrieval) =>
        GetSelectiveLooseNodesAsEnumerable(predicate, onChildRetrieval);

    public IEnumerable<INode> GetSelectiveNodesAsEnumerable(Func<INode, int, bool> predicate) => GetSelectiveLooseNodesAsEnumerable(predicate);
    ...
    public LooseReadOnlyListWithSimplePredicateWithAction GetSelectiveLooseNodesAsEnumerable(Func<INode, bool> predicate,
    ...
    public LooseReadOnlyListWithIndexBasedPredicateWithAction GetSelectiveLooseNodesAsEnumerable(Func<int, bool> predicate,
        Action<INode> onChildRetrieval)
    {
    ...
    public LooseReadOnlyListWithIndexAwarePredicateWithAction GetSelectiveLooseNodesAsEnumerable(Func<INode, int, bool> predicate,
        Action<INode> onChildRetrieval)
    {
    ...
    public LooseReadOnlyListWithSimplePredicateWithAction GetSelectiveLooseNodesAsEnumerable(Func<INode, bool> predicate, int startIndex,
        Action<INode> onChildRetrieval)
    {
    ...
    public LooseReadOnlyListWithIndexBasedPredicateWithAction GetSelectiveLooseNodesAsEnumerable(Func<int, bool> predicate, int startIndex,
        Action<INode> onChildRetrieval)
    {
    ...
    public LooseReadOnlyListWithIndexAwarePredicateWithAction GetSelectiveLooseNodesAsEnumerable(Func<INode, int, bool> predicate, int startIndex,
        Action<INode> onChildRetrieval)
    {
    ...
    public IEnumerable<INode> GetSelectiveNodesAsEnumerable(Func<INode, int, bool> predicate, int startIndex, int count,
        Action<INode> onChildRetrieval) => GetSelectiveLooseNodesAsEnumerable(predicate, startIndex, count, onChildRetrieval);
    ...
    public LooseReadOnlyListWithSimplePredicateWithAction GetSelectiveLooseNodesAsEnumerable(Func<INode, bool> predicate, int startIndex, int count,
        Action<INode> onChildRetrieval)
    {
        if (count < 0)
        {
    ...
    public LooseReadOnlyListWithIndexBasedPredicateWithAction GetSelectiveLooseNodesAsEnumerable(Func<int, bool> predicate, int startIndex, int count,
        Action<INode> onChildRetrieval)
    {
        if (count < 0)
        {
    ...
    public LooseReadOnlyListWithIndexAwarePredicateWithAction GetSelectiveLooseNodesAsEnumerable(Func<INode, int, bool> predicate, int startIndex,
        int count, Action<INode> onChildRetrieval)
    {
        if (count < 0)
        {
            throw new ArgumentOutOfRangeException(nameof(count));
    ...
    public IEnumerable<INode> GetSelectiveNodesAsEnumerableOverRange(Func<INode, bool> predicate, int startIndex, int endIndex,
        Action<INode> onChildRetrieval) => GetSelectiveLooseNodesAsEnumerableOverRange(predicate, startIndex, endIndex, onChildRetrieval);

    public IEnumerable<INode> GetSelectiveNodesAsEnumerableOverRange(Func<int, bool> predicate, int startIndex, int endIndex) =>
        GetSelectiveLooseNodesAsEnumerableOverRange(predicate, startIndex, endIndex);

    public IEnumerable<INode> GetSelectiveNodesAsEnumerableOverRange(Func<int, bool> predicate, int startIndex, int endIndex,
        Action<INode> onChildRetrieval) => GetSelectiveLooseNodesAsEnumerableOverRange(predicate, startIndex, endIndex, onChildRetrieval);

    public IEnumerable<INode> GetSelectiveNodesAsEnumerableOverRange(Func<INode, int, bool> predicate, int startIndex, int endIndex) =>
        GetSelectiveLooseNodesAsEnumerableOverRange(predicate, startIndex, endIndex);
    ...
    public LooseReadOnlyListWithSimplePredicateWithAction GetSelectiveLooseNodesAsEnumerableOverRange(Func<INode, bool> predicate, int startIndex,
    ...
    public LooseReadOnlyListWithIndexBasedPredicate GetSelectiveLooseNodesAsEnumerableOverRange(Func<int, bool> predicate, int startIndex,
        int endIndex)
    {
        return new LooseReadOnlyListWithIndexBasedPredicate(this, startIndex, endIndex, predicate);
    }

    public LooseReadOnlyListWithIndexBasedPredicateWithAction GetSelectiveLooseNodesAsEnumerableOverRange(Func<int, bool> predicate, int startIndex,
        int endIndex, Action<INode> onChildRetrieval)
    {
        return new LooseReadOnlyListWithIndexBasedPredicateWithAction(this, startIndex, endIndex, predicate, onChildRetrieval);
    }

    public LooseReadOnlyListWithIndexAwarePredicate GetSelectiveLooseNodesAsEnumerableOverRange(Func<INode, int, bool> predicate, int startIndex,
        int endIndex)
    {
        return new LooseReadOnlyListWithIndexAwarePredicate(this, startIndex, endIndex, predicate);
    }

    public LooseReadOnlyListWithIndexAwarePredicateWithAction GetSelectiveLooseNodesAsEnumerableOverRange(Func<INode, int, bool> predicate,
        int startIndex, int endIndex, Action<INode> onChildRetrieval)
    {
