...
public class SwiftPlatformCondition : PlatformCondition
{
    public Identifier? SwiftIdentifier { get; internal set; }
    ...
    public SwiftPlatformCondition(IEditableBuffer buffer, List<ISwiftNode> children)
        : base(buffer, children)
    { }

    public SwiftPlatformCondition(IEditableBuffer buffer, IEnumerable<ISwiftNode> children)
        : base(buffer, children)
    { }
