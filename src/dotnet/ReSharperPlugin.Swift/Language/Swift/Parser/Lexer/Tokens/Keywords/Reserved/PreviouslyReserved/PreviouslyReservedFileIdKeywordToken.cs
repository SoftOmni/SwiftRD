...
public class PreviouslyReservedFileIdKeywordToken : PreviouslyReservedKeywordToken<LegacyFileId>
{
    internal PreviouslyReservedFileIdKeywordToken()
        : base(LegacyFileId.Keyword,
