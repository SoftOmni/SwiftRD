...
public class PreviouslyReservedFunctionKeywordToken : PreviouslyReservedKeywordToken<LegacyFunction>
{
    internal PreviouslyReservedFunctionKeywordToken()
        : base(LegacyFunction.Keyword, SwiftTokens.PreviouslyReservedFunctionId, SwiftTokens.PreviouslyReservedFunctionIndex)
    { }
