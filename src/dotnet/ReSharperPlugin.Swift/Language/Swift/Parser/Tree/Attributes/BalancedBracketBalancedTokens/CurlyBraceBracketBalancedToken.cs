...
public class CurlyBraceBracketBalancedToken : SwiftCompositeNode,
    ICurlyBraceBracketBalancedToken
{
    public LeftCurlyBrace BalancedTokensStart { get; }

    private readonly List<IBalancedToken> _balancedTokens;

    public RightCurlyBrace BalancedTokenEnd { get; }

    internal CurlyBraceBracketBalancedToken(IEditableBuffer buffer,
        IEnumerable<ISwiftNode<SwiftCompositeNode>> children, LeftCurlyBrace balancedTokensStart,
        List<IBalancedToken> balancedTokens, RightCurlyBrace balancedTokenEnd)
