...
public class ParenthesisBracketBalancedToken : SwiftCompositeNode,
    IParenthesisBracketBalancedToken

{
    public LeftParenthesis BalancedTokensStart { get; }

    private readonly List<IBalancedToken> _balancedTokens;

    public RightParenthesis BalancedTokenEnd { get; }

    internal ParenthesisBracketBalancedToken(IEditableBuffer buffer,
        IEnumerable<ISwiftNode<SwiftCompositeNode>> children, LeftParenthesis balancedTokensStart,
        List<IBalancedToken> balancedTokens, RightParenthesis balancedTokenEnd)
