...
public class SquareBracketBalancedToken : BalancedToken, IList<BalancedToken>
{
    ...
    public SquareBracketBalancedToken(IEditableBuffer buffer, List<ISwiftNode> children) 
        : base(buffer, children)
    { }

    public SquareBracketBalancedToken(IEditableBuffer buffer, IEnumerable<ISwiftNode> children) 
        : base(buffer, children)
    { }
