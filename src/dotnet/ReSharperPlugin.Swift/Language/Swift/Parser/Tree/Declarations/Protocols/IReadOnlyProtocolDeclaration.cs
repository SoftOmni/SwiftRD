...
public interface IReadOnlyProtocolDeclaration : IReadOnlyDeclaration, 
    IReadOnlyList<IReadOnlyProtocolMember>
{
    ...
    IReadOnlyProtocolMembers Members { get; }
    
    RightCurlyBrace MembersEnd { get; }
    
    IReadOnlyList<IReadOnlyProtocolMember> MembersAsList { get; }
