...
public interface IStructureDeclaration : IReadOnlyStructureDeclaration, 
    IDeclaration,
    IList<IStructMember>
{
    ...
    new IStructMembers Members { get; }
    
    new IReadOnlyList<IStructMember> MembersAsList { get; }
    ...
    void ChangeMembers(IStructMembers newStructMembers);
}
