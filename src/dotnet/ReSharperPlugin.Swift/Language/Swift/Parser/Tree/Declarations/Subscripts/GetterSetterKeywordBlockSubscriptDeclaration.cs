...
public class GetterSetterKeywordBlockSubscriptDeclaration : SwiftCompositeNode, IGetterSetterKeywordBlockSubscriptDeclaration
{
    ...
    public IGetterSetterKeywordBlock GetterSetterKeywordBlock { get; }

    internal GetterSetterKeywordBlockSubscriptDeclaration(IEditableBuffer buffer, IEnumerable<ISwiftNode<SwiftCompositeNode>> children,
        ...
        IGetterSetterKeywordBlock getterSetterKeywordBlock)
    ...
    IReadOnlyGetterSetterKeywordBlock IReadOnlyGetterSetterKeywordBlockSubscriptDeclaration.GetterSetterKeywordBlock => GetterSetterKeywordBlock;
    ...
    public void ChangeGetterSetterKeywordBlock(IGetterSetterKeywordBlock newGetterSetterKeywordBlock)
    {
        throw new System.NotImplementedException();
    }
}
