...
{
    internal InvalidLexicalBaseForElementException(string tokenId, IBuffer buffer, string tokenValue)
        : base(GenerateMessage(tokenId, buffer, tokenValue))
    { }

    private static string GenerateMessage(string tokenId, IBuffer buffer, string tokenValue)
    {
