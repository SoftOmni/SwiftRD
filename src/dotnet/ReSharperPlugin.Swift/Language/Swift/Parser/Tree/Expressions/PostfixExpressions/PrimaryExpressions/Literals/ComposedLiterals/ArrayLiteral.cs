...
public class ArrayLiteral : LiteralExpressionInternalNode, IList<Expression>, ILiteral<Array, System.Array>
{
    ...
    public ArrayLiteral(SwiftInternalNode parent, IEditableBuffer buffer, List<ISwiftNode> nodes)
        : base(parent, buffer, nodes)
    { }

    public ArrayLiteral(SwiftInternalNode parent, IEditableBuffer buffer, IEnumerable<ISwiftNode> nodes)
        : base(parent, buffer, nodes)
    { }
