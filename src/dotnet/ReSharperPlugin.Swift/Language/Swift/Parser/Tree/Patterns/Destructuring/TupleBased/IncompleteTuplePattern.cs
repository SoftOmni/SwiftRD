...
public class IncompleteTuplePattern : SwiftErrorCompositeNode, ITuplePattern
{
    ...
    internal IncompleteTuplePattern(IEditableBuffer buffer, IEnumerable<ISwiftNode<SwiftCompositeNode>> children,
        LeftParenthesis leftParenthesis,
        List<Comma> commas, List<ITuplePatternElement> elements, RightParenthesis? rightParenthesis = null) : base(buffer,
    ...
    {
        return "Missing closing ')' for tuple pattern";
    }
}