...
public class OrCompilationCondition : SwiftCompositeNode, IOrCompilationCondition
{
    ...
    internal OrCompilationCondition(IEditableBuffer buffer, IEnumerable<ISwiftNode<SwiftCompositeNode>> children, ICompilationCondition leftOperand, IReadOnlyOperator @operator, ICompilationCondition rightOperand)
    ...
    IReadOnlyCompilationCondition IReadOnlyOrCompilationCondition.LeftOperand => LeftOperand;

    IReadOnlyCompilationCondition IReadOnlyOrCompilationCondition.RightOperand => RightOperand;
